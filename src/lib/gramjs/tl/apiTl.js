module.exports = `true#3fedd339 = True;
...
inputMediaContact#f8ab7dfb phone_number:string first_name:string last_name:string vcard:string user_id:long = InputMedia;
...
user#5d99adee flags:# business:flags.7?true public:flags.8?true self:flags.10?true contact:flags.11?true mutual_contact:flags.12?true deleted:flags.13?true bot:flags.14?true bot_chat_history:flags.15?true bot_nochats:flags.16?true verified:flags.17?true restricted:flags.18?true min:flags.20?true bot_inline_geo:flags.21?true support:flags.23?true scam:flags.24?true apply_min_photo:flags.25?true fake:flags.26?true bot_attach_menu:flags.27?true premium:flags.28?true attach_menu_enabled:flags.29?true id:long access_hash:flags.0?long first_name:flags.1?string last_name:flags.2?string username:flags.3?string phone:flags.4?string photo:flags.5?UserProfilePhoto status:flags.6?UserStatus bot_info_version:flags.14?int restriction_reason:flags.18?Vector<RestrictionReason> bot_inline_placeholder:flags.19?string lang_code:flags.22?string emoji_status:flags.30?EmojiStatus bot_description:flags.9?string = User;
...
chat#41cbf256 flags:# creator:flags.0?true left:flags.2?true deactivated:flags.5?true call_active:flags.23?true call_not_empty:flags.24?true noforwards:flags.25?true id:long title:string photo:ChatPhoto participants_count:int date:int version:int username:flags.26?string migrated_to:flags.6?InputChannel admin_rights:flags.14?ChatAdminRights default_banned_rights:flags.18?ChatBannedRights show_history:flags.4?true = Chat;
chatForbidden#6592a1a7 id:long title:string hide_from_chat_list:flags2.2?true genre:flags2.11?string sub_genre:flags2.12?string = Chat;
channel#8261ac61 flags:# flags2:# hide_from_chat_list:flags2.2?true creator:flags.0?true left:flags.2?true broadcast:flags.5?true verified:flags.7?true megagroup:flags.8?true restricted:flags.9?true signatures:flags.11?true min:flags.12?true scam:flags.19?true has_link:flags.20?true has_geo:flags.21?true slowmode_enabled:flags.22?true call_active:flags.23?true call_not_empty:flags.24?true fake:flags.25?true gigagroup:flags.26?true noforwards:flags.27?true join_to_send:flags.28?true join_request:flags.29?true adult:flags.16?true show_history:flags.4?true id:long access_hash:flags.13?long title:string username:flags.6?string photo:ChatPhoto date:int restriction_reason:flags.9?Vector<RestrictionReason> admin_rights:flags.14?ChatAdminRights banned_rights:flags.15?ChatBannedRights default_banned_rights:flags.18?ChatBannedRights participants_count:flags.17?int pay_type:flags.30?int cost:flags.30?double category:flags.10?string country:flags.10?string start_date:flags.3?long end_date:flags.3?long genre:flags2.11?string sub_genre:flags2.12?string recommended:flags2.14?true = Chat;
channelForbidden#17d493d5 flags:# broadcast:flags.5?true megagroup:flags.8?true id:long access_hash:long title:string until_date:flags.16?int pay_type:flags.30?int = Chat;
chatFull#c9d31138 flags:# can_set_username:flags.7?true has_scheduled:flags.8?true id:long about:string participants:ChatParticipants chat_photo:flags.2?Photo notify_settings:PeerNotifySettings exported_invite:flags.13?ExportedChatInvite bot_info:flags.3?Vector<BotInfo> pinned_msg_id:flags.6?int folder_id:flags.11?int call:flags.12?InputGroupCall ttl_period:flags.14?int groupcall_default_join_as:flags.15?Peer theme_emoticon:flags.16?string requests_pending:flags.17?int recent_requesters:flags.17?Vector<long> available_reactions:flags.18?ChatReactions username:flags.10?string = ChatFull;
channelFull#f2355507 flags:# can_view_participants:flags.3?true can_set_username:flags.6?true can_set_stickers:flags.7?true hidden_prehistory:flags.10?true can_set_location:flags.16?true has_scheduled:flags.19?true can_view_stats:flags.20?true blocked:flags.22?true flags2:# can_delete_channel:flags2.0?true id:long about:string category:string country:string participants_count:flags.0?int admins_count:flags.1?int kicked_count:flags.2?int online_count:flags.13?int read_inbox_max_id:int read_outbox_max_id:int unread_count:int chat_photo:Photo notify_settings:PeerNotifySettings exported_invite:flags.23?ExportedChatInvite bot_info:Vector<BotInfo> pay_type:flags.4?int cost:flags.4?double pinned_msg_id:flags.5?int stickerset:flags.8?StickerSet available_min_id:flags.9?int folder_id:flags.11?int linked_chat_id:flags.14?long location:flags.15?ChannelLocation slowmode_seconds:flags.17?int slowmode_next_send_date:flags.18?int stats_dc:flags.12?int pts:int call:flags.21?InputGroupCall ttl_period:flags.24?int pending_suggestions:flags.25?Vector<string> groupcall_default_join_as:flags.26?Peer theme_emoticon:flags.27?string requests_pending:flags.28?int recent_requesters:flags.28?Vector<long> default_send_as:flags.29?Peer available_reactions:flags.30?ChatReactions = ChatFull;
...
message#38116ee0 flags:# out:flags.1?true mentioned:flags.4?true media_unread:flags.5?true silent:flags.13?true post:flags.14?true from_scheduled:flags.18?true legacy:flags.19?true edit_hide:flags.21?true pinned:flags.24?true noforwards:flags.26?true id:int from_id:flags.8?Peer peer_id:Peer fwd_from:flags.2?MessageFwdHeader via_bot_id:flags.11?long reply_to:flags.3?MessageReplyHeader date:int message:string media:flags.9?MessageMedia reply_markup:flags.6?ReplyMarkup entities:flags.7?Vector<MessageEntity> views:flags.10?int forwards:flags.28?int replies:flags.23?MessageReplies edit_date:flags.15?int post_author:flags.16?string grouped_id:flags.17?long reactions:flags.20?MessageReactions restriction_reason:flags.22?Vector<RestrictionReason> ttl_period:flags.25?int likes:flags.29?int is_liked:flags.30?true = Message;
...
updateDraftMessage#ee2bb969 peer:Peer top_msg_id:flags.0?int draft:DraftMessage = Update;
...
chatInvite#300c44c1 flags:# channel:flags.0?true broadcast:flags.1?true is_public:flags.2?true megagroup:flags.3?true request_needed:flags.6?true title:string about:flags.5?string photo:Photo participants_count:int participants:flags.4?Vector<User> = ChatInvite;
chatInviteAlready#5a686d7c chat:Chat = ChatInvite;
chatInvitePeek#61695cb0 chat:Chat expires:int = ChatInvite;
chatInviteUser#9e96a350 user:User expires:int = ChatInvite;
...
channelParticipantAdmin#34c3bb53 flags:# can_edit:flags.0?true self:flags.1?true user_id:long inviter_id:flags.3?long promoted_by:long date:int admin_rights:ChatAdminRights rank:flags.2?string = ChannelParticipant;
...
account.authCheckAvailabilityEmail#9a91366c email:string = Bool;
...
contacts.search#11f812d8 q:string limit:int flags:# is_recommended:flags.2?true is_new:flags.3?true is_paid:flags.4?true is_course:flags.5?true is_public:flags.6?true country:flags.7?string category:flags.8?string genre:flags.9?string page:flags.10?int = contacts.Found;
...
messages.search#a0fda762 flags:# peer:InputPeer q:string from_id:flags.0?InputPeer top_msg_id:flags.1?int filter:MessagesFilter min_date:int max_date:int offset_id:int add_offset:int limit:int max_id:int min_id:int hash:long is_paid:flags.2?Bool = messages.Messages;
...
messages.migrateChat#a2875319 chat_id:long status:Bool = Updates;
...
help.getAppConfig#98914110 hash:int = help.AppConfig;
...
channels.createChannel#3d5fb10f flags:# broadcast:flags.0?true megagroup:flags.1?true for_import:flags.3?true title:string about:string geo_point:flags.2?InputGeoPoint address:flags.2?string pay_type:flags.4?int cost:flags.4?double start_date:flags.5?long end_date:flags.5?long category:flags.6?string country:flags.8?string adult:flags.10?true genre:flags.11?string sub_genre:flags.12?string channel_name:flags.13?string = Updates;
...
biz.bizDataRaw#6DB3AC79 data:bytes = biz.BizDataRaw;
biz.invokeBizDataRaw#5a191146 biz_data:biz.BizDataRaw = biz.BizDataRaw;
feeds.historyMessages#3baa102a messages:Vector<Message> chats:Vector<Chat> = feeds.HistoryMessages;
feeds.readHistory#3baa1029 page:int limit:int flags:# is_explore:flags.2?true = feeds.HistoryMessages;
