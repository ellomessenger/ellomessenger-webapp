...
namespace Api {
  ...
  export type TypeInputFileLocation = InputPeerPhotoFileLocationLegacy | InputStickerSetThumbLegacy | InputFileLocation | InputEncryptedFileLocation | InputDocumentFileLocation | InputSecureFileLocation | InputTakeoutFileLocation | InputPhotoFileLocation | InputPhotoLegacyFileLocation | InputPeerPhotoFileLocation | InputStickerSetThumb | InputGroupCallStream;
  export type TypeError = test.UseError;
  export type TypeInputAppEvent = test.ParseInputAppEvent | InputAppEvent;
  ...
  export type TypeChatInvite = ChatInvite | ChatInviteAlready | ChatInvitePeek | ChatInviteUser;
  ...
  export type TypeForumTopic = ForumTopic;
  ...
  export namespace help {
    export type TypeConfigSimple = help.ConfigSimple | test.UseConfigSimple;
  ...
  export class InputPeerPhotoFileLocationLegacy extends VirtualClass<{
    // flags: undefined;
    big?: true;
  ...
  export class InputStickerSetThumbLegacy extends VirtualClass<{
  ...
  export class ChatInviteUser extends VirtualClass<{
    user: Api.TypeUser;
    expires: int;
  }> {
    user: Api.TypeUser;
  ...
  export namespace test {
    export class UseError extends VirtualClass<void> {};
    export class UseConfigSimple extends VirtualClass<void> {};
    export class ParseInputAppEvent extends VirtualClass<void> {};
  }
  ...
  export namespace account {
    ...
    export class AuthCheckAvailabilityEmail extends Request<Partial<{
      email: string;
    }>, Bool> {
      email: string;
    };
  ...
  export namespace help {
    export class AppConfigNotModified extends Request<void, help.TypeAppConfig> {};
    export class AppConfig extends Request<Partial<{
      hash: int;
  ...
  export namespace biz {
    export class BizDataRaw extends Request<Partial<{
      data: bytes;
    }>, biz.TypeBizDataRaw> {
      data: bytes;
    };
    export class InvokeBizDataRaw extends Request<Partial<{
      bizData: biz.TypeBizDataRaw;
    }>, biz.TypeBizDataRaw> {
      bizData: biz.TypeBizDataRaw;
    };
  }
  ...
  export namespace feeds {
    export class HistoryMessages extends Request<Partial<{
      messages: Api.TypeMessage[];
      chats: Api.TypeChat[];
    }>, feeds.TypeHistoryMessages> {
      messages: Api.TypeMessage[];
      chats: Api.TypeChat[];
    };
    export class ReadHistory extends Request<Partial<{
  ...
  export type AnyRequest = InvokeAfterMsg | InvokeAfterMsgs | InitConnection | InvokeWithLayer | InvokeWithoutUpdates | InvokeWithMessagesRange | InvokeWithTakeout | ReqPq | ReqPqMulti | ReqPqMultiNew | ReqDHParams | SetClientDHParams | DestroyAuthKey | RpcDropAnswer | GetFutureSalts | Ping | PingDelayDisconnect | DestroySession
    ...
    | biz.BizDataRaw | biz.InvokeBizDataRaw
    | feeds.HistoryMessages | feeds.ReadHistory
    | chatlists.EditExportedInvite | chatlists.LeaveChatlist | chatlists.GetLeaveChatlistSuggestions | chatlists.JoinChatlistInvite | chatlists.CheckChatlistInvite | chatlists.DeleteExportedInvite | chatlists.ExportChatlistInvite | chatlists.GetExportedInvites;
