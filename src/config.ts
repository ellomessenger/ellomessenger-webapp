...
export const PRODUCTION_HOSTNAME = 'https://web.ellomessenger.com';
export const LANDING_HOSTNAME = 'https://ellomessenger.com';
export const STAGE_HOSTNAME = 'https://stage-web.ellomessenger.com/';
export const TEAM_HOSTNAME = 'https://ello.team/'; //'https://stage.ello.team/'
export const MAIL_INFO = 'info@ello.team';

export const SOCKET_URL = process.env.APP_ENV
  ? process.env.APP_ENV !== 'production'
    ? 'ws-stage.ellomessenger.com'
    : 'ws-prod.ellomessenger.com'
  : 'ws-prod.ellomessenger.com';

export const APP_NAME = process.env.APP_NAME || 'Ello Web';
export const RELEASE_DATETIME = process.env.RELEASE_DATETIME;

export const PRODUCTION_URL = 'https://web.ellomessenger.com/';
...
export const PASSCODE_CACHE_NAME = 'el-passcode';

export const GLOBAL_STATE_CACHE_DISABLED = false;
export const GLOBAL_STATE_CACHE_KEY = 'el-global-state';
...
export const MEDIA_CACHE_NAME = 'el-media';
export const MEDIA_CACHE_NAME_AVATARS = 'el-media-avatars';
export const MEDIA_PROGRESSIVE_CACHE_DISABLED = false;
export const MEDIA_PROGRESSIVE_CACHE_NAME = 'el-media-progressive';
export const CUSTOM_EMOJI_PREVIEW_CACHE_DISABLED = false;
export const CUSTOM_EMOJI_PREVIEW_CACHE_NAME = 'el-custom-emoji-preview';
export const MEDIA_CACHE_MAX_BYTES = 512 * 1024; // 512 KB
export const CUSTOM_BG_CACHE_NAME = 'el-custom-bg';
export const LANG_CACHE_NAME = 'el-lang-packs-v17';
export const ASSET_CACHE_NAME = 'el-assets';
export const AUTODOWNLOAD_FILESIZE_MB_LIMITS = [1, 5, 10, 50, 100, 500];
export const DATA_BROADCAST_CHANNEL_NAME = 'el-global';
export const ESTABLISH_BROADCAST_CHANNEL_NAME = 'el-establish';
export const MULTITAB_LOCALSTORAGE_KEY = 'el-multitab';
...
export const CHAT_HEIGHT_PX = 76;
export const CHAT_SMALL_HEIGHT_PX = 56;
...
export const DRAFT_DEBOUNCE = 3000; // 10s
...
export const CREATE_NEW_PUBLIC_CHANNEL_ID = 'newPublicChatId';
...
export const LOCAL_MESSAGE_MIN_ID = 5e3;
...
export const STICKER_SIZE_HELLO = 180;
export const STICKER_SIZE_HELLO_AI = 100;
export const STICKER_SIZE_CREATE_CHANNEL = 200;
...
export const SUPPORTED_DOC_CONTENT_TYPES = new Set([
  'application/msword',
  'application/excel',
  'application/pdf',
]);
...
export const CONTENT_TYPES_ALL = new Set([
  ...SUPPORTED_IMAGE_CONTENT_TYPES,
  ...SUPPORTED_VIDEO_CONTENT_TYPES,
...
export const CONTENT_NOT_SUPPORTED =
  'The message is not supported on this version of Ello.';
...
export const RE_TME_LINK =
  /^(https?:\/\/)?([-a-zA-Z0-9@:%_+~#=]{1,32}\.)?ello\.team/i;
export const RE_ELLO_LINK = /^(https?:\/\/)?ellomessenger\.com\//i;
export const USERNAME_REGEX = /[^a-zA-Z_\d]$/;
export const TME_LINK_PREFIX = TEAM_HOSTNAME;
export const APP_LINK_PREFIX = TEAM_HOSTNAME;

export const USERNAME_PURCHASE_ERROR = 'USERNAME_PURCHASE_AVAILABLE';
export const PURCHASE_USERNAME = 'auction';
export const TME_WEB_DOMAINS = new Set(['ello.team', 'stage.ello.team']);
...
export const AI_BOT_ID = '776999';
export const AI_BOT_PHOENIX = '776996';
export const AI_BOT_CANCER = '776994';
export const AI_BOT_BUSINESS = '776995';

// MTProto constants

export const SERVICE_NOTIFICATIONS_USER_ID = '777000';
export const SUPPORT_USER_ID = '776998';
export const REPLIES_USER_ID = '708513'; // TODO For Test connection ID must be equal to 708513
...
export const FEEDBACK_URL = 'https://bugs.ello.org/?tag_ids=41&sort=time';
export const GENERAL_TOPIC_ID = 1;

export const LIGHT_THEME_BG_COLOR = '#99BA92';
export const DARK_THEME_BG_COLOR = '#0F0F0F';
export const DEFAULT_PATTERN_COLOR = '#07070866';
export const DARK_THEME_PATTERN_COLOR = '#0A0A0A8C';
export const MAX_UPLOAD_FILEPART_SIZE = 524288;
export const FEED_BG_COLOR = [
  'bg-image-1',
  'bg-image-2',
  'bg-image-3',
  'bg-image-4',
