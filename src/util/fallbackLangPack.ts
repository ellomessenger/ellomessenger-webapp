...
export default {
  ...
  ChannelPrivateInfo: {
    ...
    value: 'Private channels can be accessed by invitation only. A QR code and Invitation link become available after the channel is created.',
  },
  ChannelPublic: {
    key: 'ChannelPublic',
  ...
  ChannelPublicInfo: {
    ...
    value: 'Public channel can be found through a search, anyone can subscribe.',
  },
