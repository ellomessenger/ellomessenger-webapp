...
import { IAiPurchases, IPayment, IWithdrawTemplate } from '../../global/types';
...
export type ApiUpdateAuthorizationStateType =
  ...
  | 'authorizationStateWaitCreatePassword'
  | 'authorizationStateWaitConfirmEmail'
...
export type ApiUpdateConfirmEmailState = {
...
export type ApiUpdatePaymentState = {
  '@type': 'updatePaymentState';
  payment: IPayment | undefined;
};

export type ApiUpdateWithdrawTemplate = {
  '@type': 'updateWithdrawTemplate';
  template: IWithdrawTemplate | undefined;
};

export type ApiUpdateAiPurchases = {
  '@type': 'updateAiPurchases';
  purchases: IAiPurchases | undefined;
};
