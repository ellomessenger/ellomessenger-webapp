...
import {
  ...
  selectIsCreateTopicPanelOpen,
  selectIsEditTopicPanelOpen,
  selectIsPollResultsOpen,
} from './messages';
import { selectCurrentTextSearch } from './localSearch';
import { selectCurrentStickerSearch, selectCurrentGifSearch } from './symbols';
import {
  selectIsStatisticsShown,
  selectIsMessageStatisticsShown,
} from './statistics';
...
export function selectRightColumnContentKey<T extends GlobalState>(
  ...
  return selectIsEditTopicPanelOpen(global, tabId)
    ...
    : selectTabState(global, tabId).newChatMembersProgress !==
...
export function selectIsForumPanelOpen<T extends GlobalState>(
  ...
  return (
    ...
    (tabState.globalSearch.query === undefined ||
      tabState.globalSearch.isClosing)
  );
}
