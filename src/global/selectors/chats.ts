...
export function selectPeer<T extends GlobalState>(
  global: T,
  peerId: string
): ApiPeer | undefined {
...
export function selectChat<T extends GlobalState>(
  global: T,
  chatId: string
): ApiChat | undefined {
...
export function selectChatFullInfo<T extends GlobalState>(
  global: T,
  chatId: string
): ApiChatFullInfo | undefined {
  return global.chats.fullInfoById[chatId];
}

export function selectChatUser<T extends GlobalState>(
  global: T,
  chat: ApiChat
) {
...
export function selectIsChatWithSelf<T extends GlobalState>(
  global: T,
  chatId: string
) {
...
export function selectIsChatWithBot<T extends GlobalState>(
  global: T,
  chat: ApiChat
) {
...
export function selectSupportChat<T extends GlobalState>(global: T) {
  return Object.values(global.chats.byId).find(
    ({ id }: ApiChat) => id === SUPPORT_USER_ID
  );
}

export function selectChatOnlineCount<T extends GlobalState>(
  global: T,
  chat: ApiChat
) {
...
export function selectChatBot<T extends GlobalState>(
  global: T,
  chatId: string
) {
...
export function selectIsTrustedBot<T extends GlobalState>(
  global: T,
  botId: string
) {
...
export function selectChatType<T extends GlobalState>(
  global: T,
  chatId: string
): ApiChatType | undefined {
  const chat = selectChat(global, chatId);
...
export function selectIsChatBotNotStarted<T extends GlobalState>(
  global: T,
  chatId: string
) {
  const chat = selectChat(global, chatId);
...
export function selectAreActiveChatsLoaded<T extends GlobalState>(
  global: T
): boolean {
...
export function selectChatFolder<T extends GlobalState>(
  global: T,
  folderId: number
) {
...
export function selectTotalChatCount<T extends GlobalState>(
  global: T,
...
export function selectChatByUsername<T extends GlobalState>(
  global: T,
  username: string
) {
  const usernameLowered = username.toLowerCase();
  return Object.values(global.chats.byId).find((chat) =>
    chat.usernames?.some((c) => c.username.toLowerCase() === usernameLowered)
  );
}
...
export function selectCanInviteToChat<T extends GlobalState>(
  global: T,
  chatId: string
) {
  const chat = selectChat(global, chatId);
...
export function selectCanShareFolder<T extends GlobalState>(
  global: T,
  folderId: number
) {
...
export function getUnreadChats<T extends GlobalState>(
  global: T,
  messages: ApiMessage[]
) {
  let chats: ApiChat[] = [];
  ...
  messages.forEach(({ chatId }) => {
    ...
    chatIds.push(chatId);
    const newChat = selectChat(global, chatId);
    if (newChat) {
      chats.push(newChat);
    }
  });
