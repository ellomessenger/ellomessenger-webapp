    ...
    <div className={buildClassName(styles.root, className)}>
      {floatingBadgeIcon && (
        <div className={styles.floatingBadge}>
          ...
          />
          <div
            className={styles.floatingBadgeValue}
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: TRIANGLE_SVG }}
          />
        </div>
      )}
      <div className={buildClassName(styles.line, styles.left)}>
        <div className={styles.leftText} dir={lang.isRtl ? 'rtl' : undefined}>
          {lang('LimitFree')}
        </div>
        {!floatingBadgeIcon && (
      ...
      <div
        className={buildClassName(styles.line, styles.right)}
        style={rightStyle}
      >
        <div className={styles.rightText} dir={lang.isRtl ? 'rtl' : undefined}>
          {lang('LimitPremium')}
        </div>
