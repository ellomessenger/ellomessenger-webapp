...
const SettingsPrivacyPublicProfilePhoto: FC<OwnProps> = ({ currentUser }) => {
  const {
    loadFullUser,
    uploadProfilePhoto,
    deleteProfilePhoto,
  ...
  return (
    <div className='settings-item'>
      <ListItem icon='camera-add' onClick={handleOpenFileSelector}>
