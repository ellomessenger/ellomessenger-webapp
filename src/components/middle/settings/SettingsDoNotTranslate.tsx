...
const SUPPORTED_LANGUAGES = SUPPORTED_TRANSLATION_LANGUAGES.filter(
  (lang: string) => LOCAL_SUPPORTED_DETECTION_LANGUAGES.includes(lang)
);
...
const SettingsDoNotTranslate: FC<OwnProps & StateProps> = ({
  ...
  useEffectWithPrevDeps(
    ([prevIsActive]) => {
      ...
      const [selected, unselected] = partition(otherLanguages, (option) =>
        doNotTranslate.includes(option.value)
      );
  ...
  return (
    <div
      className={buildClassName(styles.root, 'settings-content custom-scroll')}
    >
...
export default memo(
  withGlobal<OwnProps>((global): StateProps => {
    const { language, doNotTranslate } = global.settings.byKey;
