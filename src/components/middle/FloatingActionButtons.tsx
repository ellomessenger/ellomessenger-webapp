...
const FloatingActionButtons: FC<OwnProps & StateProps> = ({
  ...
  const handleClick = useCallback(() => {
    ...
    if (messageListType === 'thread') {
      ...
      const messagesContainer =
        elementRef.current!.parentElement!.querySelector<HTMLDivElement>(
          '.MessageList'
        )!;
  ...
  const fabClassName = classNames(
    ...
    (isShown ||
      ...
      styles.revealed,
    (Boolean(reactionsCount) || Boolean(mentionsCount)) &&
      !isShown &&
      styles.onlyReactions,
...
export default memo(
  withGlobal<OwnProps>((global): StateProps => {
    ...
    const shouldShowCount =
      chat && threadId === MAIN_THREAD_ID && messageListType === 'thread';
